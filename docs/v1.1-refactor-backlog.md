...
- Completed: `R1.1 Dashboard Output Card Extraction` (`ScheduledOutputCard` moved out of `DashboardPage`).
...
- Completed: `R6 E2E Smoke Coverage` (Playwright auth/dashboard/skills smoke path with mock Supabase client).
